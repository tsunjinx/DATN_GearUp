...
<template>
  <div class="wishlist">
    <div class="page-actions">
      ...
      <Button variant="outline" size="sm" :disabled="wish.count === 0" @click="clearAll"> Xoá tất cả </Button>
    </div>
    ...
    <div v-else class="grid">
      <Card v-for="p in wish.items" :key="p.id" class="item" :hover="true">
        ...
        <div class="actions">
          <button class="icon-btn" :aria-label="`Bỏ thích ${p.name}`" :aria-pressed="true" @click="wish.toggle(p)">
            🗑️
          </button>
